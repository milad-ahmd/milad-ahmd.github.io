    ...
    function () {
      ...
      _createClass(MatIconRegistry, [{
        ...
        value: function getSvgIconFromUrl(safeUrl) {
          ...
          */
          function (svg) {
            return _this57._cachedIconsByUrl.set(
            /** @type {?} */
            url, svg);
        ...
        value: function _getSvgFromIconSetConfigs(name, iconSetConfigs) {
          ...
          */
          function (iconSetConfig) {
            return _this58._loadSvgIconSetFromConfig(iconSetConfig).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(
            /**
            * @param {?} err
            * @return {?}
            */
            function (err) {
              /** @type {?} */
              var url = _this58._sanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_0__["SecurityContext"].RESOURCE_URL, iconSetConfig.url); // Swallow errors fetching individual URLs so the
              ...
              if (_this58._errorHandler) {
                _this58._errorHandler.handleError(new Error(errorMessage));
              } else {
          ...
          */
          function () {
            /** @type {?} */
            var foundIcon = _this58._extractIconWithNameFromAnySet(name, iconSetConfigs);
        ...
        value: function _loadSvgIconFromConfig(config) {
          ...
          */
          function (svgText) {
            return _this59._createSvgElementForSingleIcon(svgText, config.options);
          }));
        }
        /**
        ...
        value: function _loadSvgIconSetFromConfig(config) {
          ...
          */
          function (svgText) {
            ...
            if (!config.svgElement) {
              config.svgElement = _this60._svgElementFromString(svgText);
            }
        ...
        value: function _fetchUrl(safeUrl) {
          ...
          */
          function () {
            return _this61._inProgressUrlFetches["delete"](url);
    ...
    */
    ...
    function (_MatIconMixinBase2) {
      ...
      function MatIcon(elementRef, _iconRegistry, ariaHidden, _location, _errorHandler) {
        ...
        _this62 = _possibleConstructorReturn(this, _getPrototypeOf(MatIcon).call(this, elementRef));
        _this62._iconRegistry = _iconRegistry;
        _this62._location = _location;
        _this62._errorHandler = _errorHandler;
        _this62._inline = false; // If the user has not explicitly set aria-hidden, mark the icon as hidden, as this is
        ...
        value: function ngOnChanges(changes) {
          ...
          if (svgIconChanges) {
            if (this.svgIcon) {
              ...
              */
              function (svg) {
                return _this63._setSvgElement(svg);
              },
              /**
              * @param {?} err
              * @return {?}
              */
              function (err) {
                ...
                if (_this63._errorHandler) {
                  _this63._errorHandler.handleError(new Error(errorMessage));
                } else {
                  console.error(errorMessage);
                }
              });
